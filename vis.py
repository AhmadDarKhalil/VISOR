...
def folder_of_jsons_to_masks_new(input_directory,output_directory,is_overlay=False, images_root_directory= '.',input_resolution=(1920,1080), output_resolution=(1920,1080)):
    import glob
    import csv
    import pandas as pd
    import os
