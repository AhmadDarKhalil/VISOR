...
def generate_masks_for_image(image_name, image_path, masks_info, output_directory,object_keys=None, input_resolution=(1920,1080), output_resolution=(1920,1080)):
    ...
    if (not np.all(img == 0)):
        ...
        image1_val = Image.open('/jmain02/home/J2AD001/wwp01/axd53-wwp01/codes/interpolations/Images_fixed/'+os.path.basename(image1))
        ...
        a = overlay_semantic_mask(image1_val, small_lable, colors=davis_palette, alpha=0.2, contour_thickness=1)
